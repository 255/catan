...
public class AcceptTradeCommandTest {
    ...
    public void testAcceptTrade() throws Exception {
        ...
        assertTrue("Player1 should have 4 wood", game.getPlayer(0).getResources().getCount(ResourceType.WOOD) == 4);
        assertTrue("Player1 should have 6 brick", game.getPlayer(0).getResources().getCount(ResourceType.BRICK) == 6);
        assertTrue("Player2 should have 1 wood", game.getPlayer(1).getResources().getCount(ResourceType.WOOD) == 1);
