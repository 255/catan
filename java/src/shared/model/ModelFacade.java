...
public class ModelFacade implements IModelFacade {
    ...
    // take a look at the REST api for things that the facade should do
    // check for the pre conditions


    /**
     * Creates a mediator between the GUI and the Game object
     *
     * @param theGame the game object of the current game
     */
    ModelFacade(IGame theGame) {
        m_theGame = theGame;
    }
