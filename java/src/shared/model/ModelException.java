...
/**
 * An exception that is thrown when there are problems in the model classes.
 *
 * This class INTENTIONALLY uses package visibility. Only Model classes should be able
 * to create ModelExceptions.
 * @author Wyatt
 */
